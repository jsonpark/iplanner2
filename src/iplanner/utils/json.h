#ifndef IPLANNER_UTILS_JSON_H_
#define IPLANNER_UTILS_JSON_H_
...
public:
  ...
  // Object range expression
  // TODO: Wrapper of iterator of either array or object
  // TODO: Wrapper of iterator implicitly cast to Json (not Json*)
  auto begin()
  {
    if (type_ == Type::Object)
      return value_.object_ptr_->begin();

    throw std::runtime_error("Json exception: type should be object when calling begin()");
  }
  ...
  auto end()
  {
    ...
    throw std::runtime_error("Json exception: type should be object when calling end()");
  }

  auto begin() const
  {
    if (type_ == Type::Object)
      return value_.object_ptr_->cbegin();
  ...
  {
    if (type_ == Type::Object)
      return value_.object_ptr_->cend();
